...
class Ui_Blokn(object):
    ...
    def setupUi(self, Blokn):
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(360, 220, 141, 41))
        self.pushButton_2.setObjectName("pushButton_2")

        self.pushButton_2.clicked.connect(self.loadData)

        self.pushButton_3 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_3.setGeometry(QtCore.QRect(360, 40, 141, 41))
        self.pushButton_3.setObjectName("pushButton_3")
        self.pushButton_4 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_4.setGeometry(QtCore.QRect(360, 110, 141, 41))
    ...
    def retranslateUi(self, Blokn):
        ...
        self.pushButton_2.setText(_translate("Blokn", "Сохранить данные"))
