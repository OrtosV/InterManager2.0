...
from scheduler.scheduler_main import SchedulerUI
...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def but_3(self):
        self.schedulerWindow = SchedulerUI()
        self.schedulerWindow.show()
        self.SN = True
